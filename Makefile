...
install:
	...
	python3.10 -m pip install setuptools wheel twine
	# Used for linting
...
lint:
	...
	@echo flake8:
	@python3.10 -m flake8 src --count --select=E9,F63,F7,F82 --show-source --statistics
	@# exit-zero treats all errors as warnings. The GitHub editor is 127 chars wide
	@python3.10 -m flake8 src --count --exit-zero --statistics
	@echo "\n\nmypy":
